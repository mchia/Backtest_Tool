...
# Create a TA_Handler object for TSLA
tesla_ta = TA_Handler(
    symbol="BTCUSDT",                     # Ticker symbol
    screener="crypto",                # TradingView's screener (region)
    exchange="Binance",                 # Exchange (in this case, NASDAQ)
    interval=Interval.INTERVAL_1_DAY   # Time interval (e.g., 1 day)
)

# Get analysis
analysis = tesla_ta.get_analysis()
